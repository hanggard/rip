...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title>{if $index}Kriper.Ru - Страшные видео{else}{container name="title"}{/container} | Kriper.Ru - Страшные видео{/if}</title>
		...
		<div id="wrapper">
			...
			<div id="menu">
				<div id="right_menu">
					...
					<a href="/videos">все</a>
					&diams;
					{if $video_dark_count > 0}
						<a href="/videodark">тёмная комната <strong>({$video_dark_count})</strong></a>
						&diams;
					{/if}
