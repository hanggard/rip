...
<?php $_smarty_tpl->decodeProperties('a:1:{s:15:"file_dependency";a:1:{s:11:"F4128099137";a:2:{i:0;s:57:"/home/bh59538/public_html/application/views//imagetop.tpl";i:1;i:1449740858;}}}'); ?>
<?php /* Smarty version Smarty3-b5, created on 2015-12-11 20:28:12
         compiled from "/home/bh59538/public_html/application/views//imagetop.tpl" */ ?>
<?php $_block_repeat=true; $_smarty_tpl->smarty->plugin_handler->extend(array(array('template'=>"imagetemplate"), null, $_smarty_tpl->smarty, &$_block_repeat, $_smarty_tpl),'block');while ($_block_repeat) { ob_start();?>
 ...
 $_from = $_smarty_tpl->getVariable('recent_images')->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
 $_smarty_tpl->tpl_vars['smarty']->value['foreach']['recent_images']['index']=-1;
if (count($_from) > 0){
    foreach ($_from as $_smarty_tpl->tpl_vars['image']->key => $_smarty_tpl->tpl_vars['image']->value){
 $_smarty_tpl->tpl_vars['smarty']->value['foreach']['recent_images']['index']++;
?>
				<?php if ($_smarty_tpl->getVariable('smarty')->value['foreach']['recent_images']['index'] % 4==3){?>
		...
		<div class="images">
			<?php  $_smarty_tpl->tpl_vars['image'] = new Smarty_Variable;
 $_from = $_smarty_tpl->getVariable('ever_images')->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
 $_smarty_tpl->tpl_vars['smarty']->value['foreach']['ever_images']['index']=-1;
if (count($_from) > 0){
    foreach ($_from as $_smarty_tpl->tpl_vars['image']->key => $_smarty_tpl->tpl_vars['image']->value){
 $_smarty_tpl->tpl_vars['smarty']->value['foreach']['ever_images']['index']++;
?>
				<?php if ($_smarty_tpl->getVariable('smarty')->value['foreach']['ever_images']['index'] % 4==3){?>
					<?php $_smarty_tpl->assign('last',1,null,null);?>
				<?php }else{ ?>
					<?php $_smarty_tpl->assign('last',0,null,null);?>
				<?php }?>
