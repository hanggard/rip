...
<?php $_smarty_tpl->decodeProperties('a:1:{s:15:"file_dependency";a:1:{s:11:"F3592910102";a:2:{i:0;s:58:"/home/bh59538/public_html/application/views//error/404.tpl";i:1;i:1449740875;}}}'); ?>
<?php /* Smarty version Smarty3-b5, created on 2015-12-11 16:00:34
         compiled from "/home/bh59538/public_html/application/views//error/404.tpl" */ ?>
<?php $_block_repeat=true; $_smarty_tpl->smarty->plugin_handler->extend(array(array('template'=>"template"), null, $_smarty_tpl->smarty, &$_block_repeat, $_smarty_tpl),'block');while ($_block_repeat) { ob_start();?>
	<?php $_block_repeat=true; $_smarty_tpl->smarty->plugin_handler->container(array(array('name'=>"title"), null, $_smarty_tpl->smarty, &$_block_repeat, $_smarty_tpl),'block');while ($_block_repeat) { ob_start();?>Страница не найдена<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo $_smarty_tpl->smarty->plugin_handler->container(array(array('name'=>"title"), $_block_content, $_smarty_tpl->smarty, &$_block_repeat, $_smarty_tpl),'block'); }?>
	...
	<?php $_block_repeat=true; $_smarty_tpl->smarty->plugin_handler->container(array(array('name'=>"content"), null, $_smarty_tpl->smarty, &$_block_repeat, $_smarty_tpl),'block');while ($_block_repeat) { ob_start();?>
		...
		<p>Поздравляем, вас угораздило попасть на одну из трёх самых страшных страниц нашего сайта (ошибки 403, <strong>404</strong>, 500).</p>
		<p>Если вы здесь, значит, страница, которую вы искали, не существует на нашем сайте.</p>
